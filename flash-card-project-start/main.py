...
try:
    ...
    original_data = pandas.read_csv("data/frequency_list.csv")
...
def next_card():
    ...
    canvas.itemconfig(card_img, image=card_font_img)
...
card_img = canvas.create_image(400, 263, image=card_font_img)
